  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-fuchsia-600 to-emerald-500 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-2">
      <div className="w-full max-w-md p-8 rounded-2xl shadow-2xl bg-white/70 dark:bg-gray-900/80 backdrop-blur-md border border-white/20">
        <h1 className="text-3xl font-extrabold text-center mb-6 bg-gradient-to-r from-blue-600 via-fuchsia-500 to-emerald-500 dark:from-fuchsia-400 dark:via-blue-400 dark:to-emerald-400 bg-clip-text text-transparent">Sign in to your account</h1>
        <form onSubmit={handleLogin} className="flex flex-col gap-6 animate-fade-in">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 text-gray-600 dark:text-gray-300 text-sm cursor-pointer select-none">
              <input type="checkbox" checked={remember} onChange={e => setRemember(e.target.checked)} className="accent-blue-600 dark:accent-fuchsia-400 rounded focus:ring-2 focus:ring-blue-500 dark:focus:ring-fuchsia-400 transition-all" />
              Remember me
            </label>
            <a href="#" className="text-blue-600 dark:text-fuchsia-400 font-bold hover:underline text-sm transition-colors">Forgot password?</a>
          </div>
        ...
        <div className="mt-6 text-center text-gray-600 dark:text-gray-300">
          ...
          <a href="/auth/register" className="text-blue-600 dark:text-fuchsia-400 font-bold hover:underline transition-colors">Register</a>
        </div>
      </div>
    </div>
  );
